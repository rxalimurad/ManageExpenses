...
class HomeViewModel: ObservableObject {
    ...
    init() {
        let recentTransactions = [
            ...
            TransactionModel(type: .food, name: "Food", desc: "JalalSons", amount: 499.003, currencySymbol: "$", date: "Jan 03 2022 09:32 pm".toDate()),
            TransactionModel(type: .food, name: "Food", desc: "JalalSons", amount: 499.003, currencySymbol: "$", date: "Jan 03 2022 09:33 pm".toDate()),
            TransactionModel(type: .food, name: "Food", desc: "JalalSons", amount: 499.003, currencySymbol: "$", date: "Jan 03 2022 09:34 pm".toDate()),
            TransactionModel(type: .food, name: "Food", desc: "JalalSons", amount: 499.003, currencySymbol: "$", date: "Jan 03 2022 09:35 pm".toDate()),
            TransactionModel(type: .food, name: "Food", desc: "JalalSons", amount: 1.3, currencySymbol: "$", date: "Jan 04 2022 10:31 PM".toDate()),
            TransactionModel(type: .food, name: "Food", desc: "JalalSons", amount: 454.35, currencySymbol: "$", date: "Jan 05 2022 4:30 PM".toDate()),
            TransactionModel(type: .food, name: "Food", desc: "JalalSons", amount: -4, currencySymbol: "$", date: "Jan 06 2022 4:30 PM".toDate()),
            TransactionModel(type: .food, name: "Food", desc: "JalalSons", amount: 35, currencySymbol: "$", date: "Jan 07 2022 11:30 PM".toDate()),
