...
struct SignUpView: View {
    ...
    var body: some View {
        VStack {
            InputWidgetView(hint:"Name", properties: InputProperties(maxLength: 40), text: $name, isValidField: .constant(true))
                .padding([.top], 56)
            ...
            InputWidgetView(hint:"Password", properties: InputProperties(maxLength: 20, minLength: 8, isSecure: true), text: $password, isValidField: .constant(true))
                .padding([.top], 16)
                .padding([.leading, .trailing], 16)
